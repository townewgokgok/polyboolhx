...
function Intersecter(selfIntersection, eps, buildLog) {
    ...
    // event logic
    //
    var event_root = new LinkedList_1.LinkedList();
    ...
    function eventAddSegmentStart(seg, primary) {
        var ev_start = LinkedList_1.LinkedList.node({
            isStart: true,
            pt: seg.start,
            seg: seg,
            primary: primary,
    ...
    function eventAddSegmentEnd(ev_start, seg, primary) {
        var ev_end = LinkedList_1.LinkedList.node({
            isStart: false,
            pt: seg.end,
            seg: seg,
            primary: primary,
    ...
    function calculate(primaryPolyInverted, secondaryPolyInverted) {
        ...
        // status logic
        //
        var status_root = new LinkedList_1.LinkedList();
        ...
        while (!event_root.isEmpty()) {
            ...
            if (ev.isStart) {
                ...
                ev.other.status = surrounding.insert(LinkedList_1.LinkedList.node({ ev: ev }));
            }
            else {
                var st = ev.status;
                if (st === null) {
...
//# sourceMappingURL=Intersecter.js.map