...
var BuildLog = (function () {
    ...
    BuildLog.prototype.push = function (type, data) {
        this.list.push({
            type: type,
    ...
    BuildLog.prototype.segmentId = function () {
        return this.nextSegmentId++;
    };
    BuildLog.prototype.checkIntersection = function (seg1, seg2) {
        return this.push('check', { seg1: seg1, seg2: seg2 });
    };
    BuildLog.prototype.segmentChop = function (seg, end) {
        this.push('div_seg', { seg: seg, pt: end });
        return this.push('chop', { seg: seg, pt: end });
    };
    BuildLog.prototype.statusRemove = function (seg) {
        return this.push('pop_seg', { seg: seg });
    };
    BuildLog.prototype.segmentUpdate = function (seg) {
        return this.push('seg_update', { seg: seg });
    };
    BuildLog.prototype.segmentNew = function (seg, primary) {
        return this.push('new_seg', { seg: seg, primary: primary });
    };
    BuildLog.prototype.segmentRemove = function (seg) {
        return this.push('rem_seg', { seg: seg });
    };
    BuildLog.prototype.tempStatus = function (seg, above, below) {
        return this.push('temp_status', { seg: seg, above: above, below: below });
    };
    BuildLog.prototype.rewind = function (seg) {
        return this.push('rewind', { seg: seg });
    };
    BuildLog.prototype.status = function (seg, above, below) {
        return this.push('status', { seg: seg, above: above, below: below });
    };
    BuildLog.prototype.vert = function (x) {
        if (x === this.curVert)
            return this;
        this.curVert = x;
        return this.push('vert', { x: x });
    };
    BuildLog.prototype.log = function (data) {
        if (typeof data !== 'string')
            data = JSON.stringify(data, null, '  ');
        return this.push('log', { txt: data });
    };
    BuildLog.prototype.reset = function () {
        return this.push('reset');
    };
    BuildLog.prototype.selected = function (segs) {
        return this.push('selected', { segs: segs });
    };
    BuildLog.prototype.chainStart = function (seg) {
        return this.push('chain_start', { seg: seg });
    };
    BuildLog.prototype.chainRemoveHead = function (index, pt) {
        return this.push('chain_rem_head', { index: index, pt: pt });
    };
    BuildLog.prototype.chainRemoveTail = function (index, pt) {
        return this.push('chain_rem_tail', { index: index, pt: pt });
    };
    BuildLog.prototype.chainNew = function (pt1, pt2) {
        return this.push('chain_new', { pt1: pt1, pt2: pt2 });
    };
    BuildLog.prototype.chainMatch = function (index) {
        return this.push('chain_match', { index: index });
    };
    BuildLog.prototype.chainClose = function (index) {
        return this.push('chain_close', { index: index });
    };
    BuildLog.prototype.chainAddHead = function (index, pt) {
        return this.push('chain_add_head', { index: index, pt: pt });
    };
    BuildLog.prototype.chainAddTail = function (index, pt) {
        return this.push('chain_add_tail', { index: index, pt: pt });
    };
    BuildLog.prototype.chainConnect = function (index1, index2) {
        return this.push('chain_con', { index1: index1, index2: index2 });
    };
    BuildLog.prototype.chainReverse = function (index) {
        return this.push('chain_rev', { index: index });
    };
    BuildLog.prototype.chainJoin = function (index1, index2) {
        return this.push('chain_join', { index1: index1, index2: index2 });
    };
    BuildLog.prototype.done = function () {
...
var Epsilon = (function () {
    function Epsilon(eps) {
        if (eps === void 0) { eps = 0.0000000001; }
        this.eps = eps;
    }
    Epsilon.prototype.epsilon = function (v) {
        if (typeof v === 'number')
            this.eps = v;
        return this.eps;
    };
    Epsilon.prototype.pointAboveOrOnLine = function (pt, left, right) {
        var Ax = left[0];
        var Ay = left[1];
        var Bx = right[0];
        var By = right[1];
    ...
    Epsilon.prototype.pointBetween = function (p, left, right) {
    ...
    Epsilon.prototype.pointsSameX = function (p1, p2) {
        return Math.abs(p1[0] - p2[0]) < this.eps;
    };
    Epsilon.prototype.pointsSameY = function (p1, p2) {
        return Math.abs(p1[1] - p2[1]) < this.eps;
    };
    Epsilon.prototype.pointsSame = function (p1, p2) {
        return this.pointsSameX(p1, p2) && this.pointsSameY(p1, p2);
    };
    Epsilon.prototype.pointsCompare = function (p1, p2) {
        // returns -1 if p1 is smaller, 1 if p2 is smaller, 0 if equal
        if (this.pointsSameX(p1, p2))
            return this.pointsSameY(p1, p2) ? 0 : (p1[1] < p2[1] ? -1 : 1);
        return p1[0] < p2[0] ? -1 : 1;
    };
    Epsilon.prototype.pointsCollinear = function (pt1, pt2, pt3) {
    ...
    Epsilon.prototype.linesIntersect = function (a0, a1, b0, b1) {
    ...
    Epsilon.prototype.pointInsideRegion = function (pt, region) {
        var x = pt[0];
        var y = pt[1];
...
//
var GeoJSONNode = (function () {
    function GeoJSONNode(region) {
        this.region = region;
        this.children = [];
    }
    return GeoJSONNode;
...
var GeoJSON = (function () {
    ...
    GeoJSON.fromPolygon = function (PolyBool, eps, poly) {
        ...
        var roots = new GeoJSONNode(null);
...
var LinkedList = (function () {
    ...
    LinkedList.prototype.exists = function (node) {
    ...
    LinkedList.prototype.insertBefore = function (node, check) {
        var last = this.root;
    ...
    LinkedList.prototype.findTransition = function (check) {
        var prev = this.root;
        var here = this.root.next;
        while (here != null) {
            if (check(here))
 ...
 */
var PolyBoolStatic = (function () {
    function PolyBoolStatic() {
        this._epsilon = new Epsilon();
    }
    // getter/setter for buildLog
    PolyBoolStatic.prototype.buildLog = function (bl) {
        if (bl)
    ...
    PolyBoolStatic.prototype.epsilon = function (v) {
        return this._epsilon.epsilon(v);
    };
    // core API
    PolyBoolStatic.prototype.segments = function (poly) {
    ...
    PolyBoolStatic.prototype.combine = function (segments1, segments2) {
    ...
    // GeoJSON converters
    PolyBoolStatic.prototype.polygonFromGeoJSON = function (geojson) {
        return GeoJSON.toPolygon(this, geojson);
    };
    PolyBoolStatic.prototype.polygonToGeoJSON = function (poly) {
        return GeoJSON.fromPolygon(this, this._epsilon, poly);
    };
    // helper functions for common operations
    PolyBoolStatic.prototype.union = function (poly1, poly2) {
        return operate(poly1, poly2, this.selectUnion.bind(this));
    };
    PolyBoolStatic.prototype.intersect = function (poly1, poly2) {
        return operate(poly1, poly2, this.selectIntersect.bind(this));
    };
    PolyBoolStatic.prototype.difference = function (poly1, poly2) {
        return operate(poly1, poly2, this.selectDifference.bind(this));
    };
    PolyBoolStatic.prototype.differenceRev = function (poly1, poly2) {
        return operate(poly1, poly2, this.selectDifferenceRev.bind(this));
    };
    PolyBoolStatic.prototype.xor = function (poly1, poly2) {
        return operate(poly1, poly2, this.selectXor.bind(this));
    };
    return PolyBoolStatic;
}());
